...
[![Master Pipeline](https://github.com/MStarRobotics/Fractal-Recipe-Generator/actions/workflows/master-pipeline.yml/badge.svg?branch=main)](https://github.com/MStarRobotics/Fractal-Recipe-Generator/actions/workflows/master-pipeline.yml)
...
> Live architecture graph (auto-updated on merges to main):

<p align="center">
  <img src="./docs/architecture.svg" alt="Project architecture graph" />
  <br/>
  <sub>Generated by dependency-cruiser + Graphviz</sub>
...
- Unified authentication portal with MetaMask, phone OTP, and email link flows.
...
- Local hooks: Husky + lint-staged prevent committing code that fails format, lint, or typecheck.
- CI pipeline (master-pipeline): Lints, typechecks, builds, audits dependencies, and runs CodeQL.
- Dependency updates: Dependabot opens PRs weekly for minor/patch bumps.
- Architecture graph: CI auto-generates `docs/architecture.svg` on every push to `main`.
